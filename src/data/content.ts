...
export const profile = {
  ...
  avatar: "/avatar.jpg",
  tagline:
    "Software engineer with 6 years building and modernizing .NET microservices and external API integrations — the last 4 in healthcare/pharmacy, and earlier in fintech payments. Working knowledge of Go, with a focus on clean, maintainable architecture.",
  // Longer bio for the About section.
  about: [
    "I'm a backend engineer who specializes in .NET microservices and the integrations that connect them. Across 6 years I've shipped and maintained services in two regulated domains — spending the last 4 years in healthcare/pharmacy, building .NET microservices for a prescription-discount platform that surfaces real-time pharmacy pricing and coupon information, and before that in B2B fintech payments — where correctness, reliability, and clean architecture genuinely matter.",
    "Most of my recent work has been modernization: leading the end-to-end migration of business-critical microservices to .NET 9, refactoring a 1,700-line service down to ~400 lines with Clean Architecture and dependency injection, owning caching strategy with Redis, and migrating legacy monoliths into well-structured services. I also picked up Go on the job — contributing endpoints and migrating services across both the Go and .NET stacks.",
...
export const experience: Experience[] = [
  {
    role: "Software Engineer",
    org: "Healthcare / Pharmacy Solutions",
    period: "2022 — Present",
    highlights: [
      "Integrate new PBMs into the platform end to end — connecting to each provider's external APIs and flattening their varied responses into a consistent microservice contract — so their pricing and prescription-discount coupons are usable at the pharmacy.",
      ...
      "Partnered with other engineers to migrate another service from legacy .NET to a modern .NET 9 microservice — applying the same Clean Architecture patterns, re-implementing coupon email delivery, and splitting one overloaded coupon-delivery endpoint into dedicated endpoints per delivery method.",
      ...
      "Work within a CI/CD release process — deploying services across environments from lower envs through production and helping ensure successful releases.",
  ...
  },
  {
    ...
    highlights: [
      ...
      "Delivered features end to end across API controllers, business logic, and the database — including a full client integration ported from an on-premise system into the cloud platform.",
      "Validated new implementations through each stage of the CI/CD release cycle, confirming they ran successfully in production.",
...
export const projects: Project[] = [
  {
    ...
    repos: [
      { label: "Source", href: "https://github.com/YawDev/personal-blog-site" },
    ],
  },
  {
    ...
    repos: [
      { label: "API", href: "https://github.com/YawDev/todo-web-api" },
      { label: "Web", href: "https://github.com/YawDev/todo-app-react" },
    ],
  },
];
