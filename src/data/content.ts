...
export const experience: Experience[] = [
  {
    ...
    period: "2022 — Present",
    highlights: [
      "Own new PBM integrations end to end and provide ongoing support for existing provider integrations, including API contract mapping, observability, error handling, testing, QA coordination, and production reliability for customer-facing pharmacy pricing and discount-coupon experiences that help users save on prescription medications.",
      "Owned and extended the business-critical service that surfaces real-time pharmacy pricing across external PBMs, then led its end-to-end migration to .NET 9 by re-architecting it around Clean Architecture and clear separation of concerns to improve maintainability while preserving existing platform functionality. Maintained parity between legacy and modernized implementations throughout the migration, documented core business logic and APIs, and improved onboarding by making the service easier to understand, test, and extend.",
      "Own the platform’s caching strategy using Redis and Hangfire background jobs to reduce request latency, minimize database load, and ensure frequently accessed data remains available and up to date.",
      ...
      "Contributed to the modernization of a core legacy service that powers the prescription discount-coupon experience by redesigning API endpoints, re-implementing key business capabilities at parity, and applying consistent architectural patterns without disrupting existing functionality.",
