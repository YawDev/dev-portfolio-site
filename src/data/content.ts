...
export const experience: Experience[] = [
  {
    ...
    period: "2022 — Present",
    highlights: [
      "Currently integrate new PBMs into the platform end to end by connecting to each provider's external APIs and flattening their varied responses into a consistent microservice contract — so their pricing and prescription-discount coupons are usable at the pharmacy, then shepherd each release across environments through to production.",
      "Led the end-to-end migration of a business-critical microservice to .NET 9 by improving architecture and separation of concerns, reducing implementation complexity which made the service far easier to test and extend. Documented the core business logic and endpoints to speed onboarding for other engineers.",
      ...
      "Worked across both Go and .NET — independently migrated a Go microservice with REST and gRPC (Protobuf) endpoints, and collaborated on cross-stack legacy migrations",
